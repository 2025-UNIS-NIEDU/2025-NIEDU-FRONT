...
import base from "./OnboardingIntro1.module.css"; // viewport/container/nextButton 재사용
import s from "./OnboardingAlarm.module.css"; // 알람 전용 CSS(아래 제공)
  ...
  const requestPermission = async () => {
    try {
      ...
      if (perm === "granted") {
        ...
        // TODO: 여기서 실제 푸시 구독(서버에 구독 정보 등록) 로직 연결
      ...
      <div className={base.container}>
        <header className={s.header}>
          <h1 className={s.title}>
            매일 뉴스를 학습하시도록<br />기본 알람 설정을 해드릴게요.
          </h1>
